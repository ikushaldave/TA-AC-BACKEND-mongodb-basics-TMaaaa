...
```
mongoimport --host localhost:27017 --db test --collection users --file ~/Downloads/generated.json
```
...
```
mongoexport --host="localhost" --port=27017 --collection=users --db=test --out=users.json
```
...
```
mongoimport --host localhost --port 27017 --db test --collection students --type csv --file ~/Downloads/convertcsv.csv --headerline
```